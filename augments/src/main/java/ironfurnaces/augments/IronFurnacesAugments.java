...
public class IronFurnacesAugments implements ModInitializer {
	...
	public void onInitialize() {
		Registry.register(BuiltInRegistries.ITEM, Identifier.fromNamespaceAndPath(MOD_ID, "augment_blasting"),
				BLASTING_AUGMENT);
		Registry.register(BuiltInRegistries.ITEM, Identifier.fromNamespaceAndPath(MOD_ID, "augment_smoking"),
				SMOKING_AUGMENT);
		Registry.register(BuiltInRegistries.ITEM, Identifier.fromNamespaceAndPath(MOD_ID, "augment_speed"),
				SPEED_AUGMENT);
		Registry.register(BuiltInRegistries.ITEM, Identifier.fromNamespaceAndPath(MOD_ID, "augment_fuel"),
				FUEL_AUGMENT);
