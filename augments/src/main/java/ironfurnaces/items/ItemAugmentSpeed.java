...
public class ItemAugmentSpeed extends Item {
	...
	public void appendHoverText(ItemStack stack, Item.TooltipContext context,
		...
		tooltip.accept(Component.translatable("tooltip.ironfurnaces_augments.augment_speed_pro")
				.withStyle(ChatFormatting.GREEN));
		tooltip.accept(Component.translatable("tooltip.ironfurnaces_augments.augment_speed_con")
