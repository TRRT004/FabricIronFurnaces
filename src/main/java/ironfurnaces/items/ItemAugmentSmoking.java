...
public class ItemAugmentSmoking extends ItemAugment {
	...
	public void appendHoverText(ItemStack stack, Item.TooltipContext context,
		...
		tooltip.accept(Component.translatable("tooltip." + Reference.MOD_ID + ".augment_smoking_pro")
				.withStyle(ChatFormatting.GREEN));
		tooltip.accept(Component.translatable("tooltip." + Reference.MOD_ID + ".augment_smoking_con")
