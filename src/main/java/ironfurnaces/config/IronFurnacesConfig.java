...
public class IronFurnacesConfig {
    ...
    @Config(config = "ironfurnaces", category = "furnaces", key = "furnaceXPDropValue2",
            comment = " This value indicates when the furnace should 'overload' and spit out the xp stored. \n Default: 100000, Single recipe uses")
    public static int furnaceXPDropValue2 = 100000;

    @Config(config = "ironfurnaces", category = "energy", key = "energy_usage",
            comment = " This value determines how much energy used per smelted item in the wireless heater. \n Default: 250")
