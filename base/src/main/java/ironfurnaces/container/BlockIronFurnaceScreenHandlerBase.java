...
public abstract class BlockIronFurnaceScreenHandlerBase extends AbstractContainerMenu {
    ...
    public ItemStack quickMoveStack(Player player, int index) {
        boolean hasAugmentSlot = net.fabricmc.loader.api.FabricLoader.getInstance().isModLoaded("ironfurnaces_augments");
        ...
        if (slot != null && slot.hasItem()) {
            ...
            // Move from player inventory -> container
                ...
                } else if (index >= playerInvStart + 27 && index < playerInvStart + 36 && !this.moveItemStackTo(itemStack2, playerInvStart, playerInvStart + 27, false)) {
                    return ItemStack.EMPTY;
                }
            } 
